    ...
    public class SubscribersController : Controller
    {
        ...
        public async Task<IActionResult> Create(SubscriberFormViewModel model)
        {
            ...
            if (model.HasWhatsApp)
            {
                ...
                var mobileNumber = _webHostEnvironment.IsDevelopment() ? "01068387239" : model.MobileNumber;

                //Change 2 with your country code
                // add this service for sending email to backgroundjob by using hangfire package
        ...
        public IActionResult RenewSubscription(string sKey)
        {
            ...
            if (subscriber.HasWhatsApp)
            {
                ...
                // this is before adding backgroundjobs
                 //awaot _whatsAppClient
