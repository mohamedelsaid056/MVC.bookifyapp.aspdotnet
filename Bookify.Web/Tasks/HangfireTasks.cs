...
namespace Bookify.Web.Tasks
{
    public class HangfireTasks
    {
        ...
        //send alert to remember expireation date of subscription
        public async Task PrepareExpirationAlert()
        {
            ...
            foreach (var subscriber in subscribers)
            {
                ...
                if (subscriber.HasWhatsApp)
                {
                    ...
                    var mobileNumber = _webHostEnvironment.IsDevelopment() ? "01068387239" : subscriber.MobileNumber;
        ...
        //send alert to remind expireation date of rental of books
