...
function drawRentalsChart(startDate = null, endDate = null) {
  ...
  if (!element) {
    return; // in the orgianl code we have this return without function so we have error
    // so when we take code form orginal site so we need to put this codq in function inorder to work "retrun"
  }
